(function (t, e) {
  ...
  (function t() {
    (function (t, e) {
      ...
      function U(t) {
        x(
          t !== null && typeof t === "object" && t.length !== undefined,
      ...
      var Z = (function t() {
        ...
        e.getAxialAlignedBoundingBox = function t(r, n) {
          ...
          return [
            Math.min(a[0], i[0], s[0], o[0]),
            Math.min(a[1], i[1], s[1], o[1]),
            Math.max(a[0], i[0], s[0], o[0]),
            Math.max(a[1], i[1], s[1], o[1]),
          ];
        };
      ...
      function et(t) {
        ...
        if (t[0] === "þ" && t[1] === "ÿ") {
          for (e = 2; e < r; e += 2) {
            n.push(
              String.fromCharCode((t.charCodeAt(e) << 8) | t.charCodeAt(e + 1))
            );
          }
        } else {
          for (e = 0; e < r; ++e) {
      ...
      function ht(t) {
        return (
          typeof t === "object" && t !== null && t.byteLength !== undefined
        );
      }
      function ut(t) {
          ...
          _updateStatus: function t(e, r) {
            ...
            if (e === n && o.isPromise(r)) {
              r.then(
                ...
                this._updateStatus.bind(this, a)
              );
              return;
            }
            this._status = e;
      ...
      function n(t) {
        return t.replace(/>\\376\\377([^<]+)/g, function (t, e) {
          ...
          for (var a = 0; a < r.length; a += 2) {
            ...
            n +=
              i >= 32 && i < 127 && i !== 60 && i !== 62 && i !== 38
                ? String.fromCharCode(i)
                : "&#x" + (65536 + i).toString(16).substring(1) + ";";
          }
          return ">" + n;
        });
      }
    ...
    (function (t, e) {
      e(
        (t.pdfjsDisplayAnnotationLayer = {}),
        t.pdfjsSharedUtil,
        t.pdfjsDisplayDOMUtils
      );
    })(this, function (t, e, r) {
      ...
      var d = (function t() {
        ...
        e.prototype = {
          _createContainer: function t() {
            ...
            var u = i.normalizeRect([
              e.rect[0],
              r.view[3] - e.rect[1] + r.view[1],
              e.rect[2],
              r.view[3] - e.rect[3] + r.view[1],
            ]);
            ...
            if (e.borderStyle.width > 0) {
              ...
              if (e.color) {
                s.style.borderColor = i.makeCssRgb(
                  e.color[0] | 0,
                  e.color[1] | 0,
                  e.color[2] | 0
                );
          ...
          render: function t(e) {
            ...
            for (var n = 0, a = e.annotations.length; n < a; n++) {
              ...
              var s = {
                ...
                imageResourcesPath:
                  e.imageResourcesPath || u("imageResourcesPath"),
                ...
                case "BM":
                  if (s && s.name && s.name !== "Normal") {
                    ...
                    if (this.ctx.globalCompositeOperation !== o) {
                      b(
                        'globalCompositeOperation "' + o + '" is not supported'
                      );
                    }
                  } else {
    ...
    (function (t, e) {
      e(
        (t.pdfjsDisplayAPI = {}),
        t.pdfjsSharedUtil,
        t.pdfjsDisplayFontLoader,
        t.pdfjsDisplayCanvas,
        t.pdfjsDisplayMetadata,
        t.pdfjsDisplayDOMUtils
      );
      ...
      var K = (function t() {
        ...
        e.prototype = {
          ...
          render: function t(e) {
            ...
            var l = this;
            i.displayReadyCapability.promise.then(
              function t(e) {
                if (l.pendingCleanup) {
                  c();
                  return;
          ...
          getTextContent: function t(e) {
            return this.transport.messageHandler.sendWithPromise(
              "GetTextContent",
              {
                pageIndex: this.pageNumber - 1,
                normalizeWhitespace:
                  e && e.normalizeWhitespace === true ? true : false,
                combineTextItems:
                  e && e.disableCombineTextItems === true ? false : true,
              }
            );
          },
          _destroy: function t() {
    ...
    (function (t, e) {
      ...
      g.disableFontFace =
        g.disableFontFace === undefined ? false : g.disableFontFace;
      g.imageResourcesPath =
        g.imageResourcesPath === undefined ? "" : g.imageResourcesPath;
      ...
      g.disableAutoFetch =
        g.disableAutoFetch === undefined ? false : g.disableAutoFetch;
      g.pdfBug = g.pdfBug === undefined ? false : g.pdfBug;
      g.postMessageTransfers =
        g.postMessageTransfers === undefined ? true : g.postMessageTransfers;
      g.disableCreateObjectURL =
        g.disableCreateObjectURL === undefined
          ? false
          : g.disableCreateObjectURL;
      g.disableWebGL = g.disableWebGL === undefined ? true : g.disableWebGL;
      g.externalLinkTarget =
        g.externalLinkTarget === undefined ? d.NONE : g.externalLinkTarget;
      g.externalLinkRel =
        g.externalLinkRel === undefined ? p : g.externalLinkRel;
      g.isEvalSupported =
        g.isEvalSupported === undefined ? true : g.isEvalSupported;
