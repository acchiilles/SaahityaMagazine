            ...
            !(function (e) {
              ...
              function n(a) {
                var b,
                  ...
                  s = D,
                  t = C;
                for (c = a.lastIndexOf(E), 0 > c && (c = 0), d = 0; c > d; ++d)
              ...
              function o(a) {
                var b,
                  ...
                  u = [];
                for (
                  a = i(a), q = a.length, b = D, c = 0, g = C, h = 0;
                  q > h;
                  ++h
                )
                ...
                for (d = e = u.length, e && u.push(E); q > d; ) {
                  ...
                  for (
                    ...
                    if (
                      ((p = a[h]), b > p && ++c > w && f("overflow"), p == b)
                    ) {
                      for (
                        k = c, n = x;
                        (o = g >= n ? y : n >= g + z ? z : n - g), !(o > k);
                        n += x
                      )
                        (t = k - o),
                          (s = x - o),
        ...
        function (a, b, c) {
          ...
          function f(a, b) {
            for (
              ...
              (b === !0 || 1 !== d.nodeType || "SCRIPT" !== d.nodeName) &&
                c.appendChild(f(d, b)),
                (d = d.nextSibling);
            return (
              1 === a.nodeType &&
                ...
                "CANVAS" === a.nodeName
                  ? e(a, c)
                  : ("TEXTAREA" === a.nodeName || "SELECT" === a.nodeName) &&
                    (c.value = a.value)),
              c
            );
          }
                      ...
                      c.body.childNodes.length > 0 &&
                        ...
                        "view" === h.type &&
                          ...
                          !/(iPad|iPhone|iPod)/g.test(navigator.userAgent) ||
                            (l.contentWindow.scrollY === j &&
                              l.contentWindow.scrollX === i) ||
        ...
        function (b, c, d) {
          function e(a, b) {
            ...
            if (
              ((b = b || {}),
              b.logging &&
                ((r.options.logging = !0), (r.options.start = Date.now())),
              (b.async = "undefined" == typeof b.async ? !0 : b.async),
              (b.allowTaint =
                "undefined" == typeof b.allowTaint ? !1 : b.allowTaint),
              (b.removeContainer =
                "undefined" == typeof b.removeContainer
                  ? !0
                  : b.removeContainer),
              (b.javascriptEnabled =
                "undefined" == typeof b.javascriptEnabled
                  ? !1
                  : b.javascriptEnabled),
              (b.imageTimeout =
                "undefined" == typeof b.imageTimeout ? 1e4 : b.imageTimeout),
            ...
            var h = (
              void 0 === a ? [document.documentElement] : a.length ? a : [a]
            )[0];
            return (
              h.setAttribute(w + c, c),
              f(
                h.ownerDocument,
                b,
          ...
          function h(a, b) {
            b.removeContainer &&
              (a.parentNode.removeChild(a), r("Cleaned up container"));
          }
          function i(a, b) {
      ...
      7: [
        function (a, b, c) {
          ...
          (d.prototype.getMetrics = function (a, b) {
            return (
              void 0 === this.data[a + "-" + b] &&
                (this.data[a + "-" + b] = new e(a, b)),
              this.data[a + "-" + b]
            );
          }),
            (b.exports = d);
          ...
          (d.prototype.findImages = function (a) {
              ...
              a
                .reduce(function (a, b) {
                  switch (b.node.nodeName) {
                    ...
                    case "IFRAME":
                      return a.concat([
                        { args: [b.node], method: b.node.nodeName },
                      ]);
                  }
                  return a;
                }, [])
            ...
            (d.prototype.loadImage = function (a) {
              ...
              return "linear-gradient" === a.method
                ...
                ? new i(
                    a.args[0],
                    this.isSameOrigin(a.args[0].src),
                    this.options
                  )
                : new g(a);
            }),
            (d.prototype.isSVG = function (a) {
              return (
                "svg" === a.substring(a.length - 3).toLowerCase() ||
                j.prototype.isInline(a)
              );
            }),
            ...
            (d.prototype.fetch = function (a) {
              return (
                (this.images = a.reduce(
                  n(this.findBackgroundImage, this),
                  this.findImages(a)
                )),
      ...
      12: [
        function (a, b, c) {
          function d(a) {
            ...
            var b =
              d.REGEXP_DIRECTION.test(a.args[0]) ||
              !e.REGEXP_COLORSTOP.test(a.args[0]);
            b
              ? a.args[0]
                  .split(/\s+/)
                  .reverse()
          ...
          (d.prototype.cloneTo = function (a) {
            ...
            (d.prototype.parseBackgroundImages = function () {
              return (
                ...
                (this.backgroundImages = m(this.css("backgroundImage")))
              );
            }),
            (d.prototype.cssList = function (a, b) {
              ...
              return (
                (c = c[b || 0] || c[0] || "auto"),
                (c = c.trim().split(" ")),
                1 === c.length && (c = [c[0], g(c[0]) ? "auto" : c[0]]),
                c
              );
            }),
            ...
            (d.prototype.parseBackgroundPosition = function (a, b, c, d) {
              var e,
                f,
                h = this.cssList("backgroundPosition", c);
              return (
                (e = g(h[0])
                  ? (a.width - (d || b).width) * (parseFloat(h[0]) / 100)
                  : parseInt(h[0], 10)),
                (f =
                  "auto" === h[1]
                    ? (e / b.width) * b.height
                    : g(h[1])
                    ? ((a.height - (d || b).height) * parseFloat(h[1])) / 100
                    : parseInt(h[1], 10)),
                "auto" === h[0] && (e = (f / b.height) * b.width),
                { left: e, top: f }
              );
            }),
            ...
            (d.prototype.parseTextShadows = function () {
              ...
              if (a && "none" !== a)
                for (
                  var c = a.match(this.TEXT_SHADOW_PROPERTY), d = 0;
                  c && d < c.length;
                  d++
                ) {
              ...
              if (!this.transformData)
                if (this.hasTransform()) {
                  var a = this.parseBounds(),
                    b = this.prefixedCss("transformOrigin")
                      .split(" ")
                      .map(h)
                      .map(i);
                  (b[0] += a.left),
      ...
      15: [
        function (a, b, c) {
          function d(a, b, c, d, e) {
            ...
            if (
              (e.background &&
                b.rectangle(0, 0, b.width, b.height, new U(e.background)),
          ...
          function j(a, b, c) {
            ...
            return {
              ...
              bottomRightOuter: i(d + s, e + r, m, n).bottomRight.subdivide(
                0.5
              ),
              bottomRightInner: i(
          ...
          function l(a, b, c, d, e, f, g) {
            ...
            return (
              b[0] > 0 || b[1] > 0
                ? (h.push(["line", d[1].start.x, d[1].start.y]),
                  d[1].curveTo(h))
          ...
          function v(a) {
            return (
              a.nodeType === Node.TEXT_NODE || a.nodeType === Node.ELEMENT_NODE
            );
          }
          function w(a) {
            var b = a.css("position"),
              c =
                -1 !== ["absolute", "relative", "fixed"].indexOf(b)
                  ? a.css("zIndex")
                  : "auto";
            return "auto" !== c;
          }
          ...
          function z(a) {
            return (
              -1 !== ["inline-block", "inline-table"].indexOf(a.css("display"))
            );
          }
          function A(a) {
            var b = this;
          ...
          function K(a) {
            var b = a.substr(0, 1);
            return b === a.substr(a.length - 1) && b.match(/'|"/)
          ...
          function L(a) {
            for (var b, c = [], d = 0, e = !1; a.length; )
              M(a[d]) === e
                ? ((b = a.splice(0, d)),
                  b.length && c.push(P.ucs2.encode(b)),
                  (e = !e),
                  (d = 0))
                : d++,
                d >= a.length &&
                  ((b = a.splice(0, d)), b.length && c.push(P.ucs2.encode(b)));
            return c;
          }
          function M(a) {
          ...
          (d.prototype.calculateOverflowClips = function () {
            this.nodes.forEach(function (a) {
              if (B(a)) {
                ...
                var b = "hidden" === a.css("overflow") ? [a.borders.clip] : [],
                  c = a.parseClip();
                c &&
                  -1 !== ["absolute", "fixed"].indexOf(a.css("position")) &&
                  b.push([
                    [
                      "rect",
                  ...
                  (a.backgroundClip =
                    "hidden" !== a.css("overflow")
                      ? a.clip.concat([a.borders.clip])
                      : a.clip),
                  C(a) && a.cleanDOM();
              ...
              for (
                var d = K(c.content),
                  ...
                  g = document.createElement(
                    e ? "img" : "html2canvaspseudoelement"
                  ),
                  h = new S(g, a, b),
                  i = c.length - 1;
                i >= 0;
            ...
            (d.prototype.getChildren = function (a) {
              return J(
                [].filter.call(a.node.childNodes, v).map(function (b) {
                  var c = [
                    b.nodeType === Node.TEXT_NODE ? new R(b, a) : new Q(b, a),
                  ].filter(I);
            ...
            (d.prototype.isBodyWithTransparentRoot = function (a) {
              return (
                "BODY" === a.node.nodeName &&
                a.parent.color("backgroundColor").isTransparent()
              );
            }),
            ...
            (d.prototype.getRangeBounds = function (a, b, c) {
              var d =
                this.range || (this.range = a.ownerDocument.createRange());
              return (
                d.setStart(a, b), d.setEnd(a, b + c), d.getBoundingClientRect()
              );
            }),
              ...
              b.concat(e)
                ...
                .forEach(function (a) {
                  this.renderQueue.push(a),
                    r(a) && (this.parse(a), this.renderQueue.push(new g()));
                }, this);
            }),
            ...
            (d.prototype.paintText = function (a) {
              ...
              var b = P.ucs2.decode(a.node.data),
                c =
                  (this.options.letterRendering && !t(a)) || N(a.node.data)
                    ? b.map(function (a) {
              ...
              this.renderer.font(
                ...
                this.renderer.clip(
                  a.parent.clip,
                  function () {
                    c.map(this.parseTextBounds(a), this).forEach(function (
                      b,
                      d
                    ) {
                      b &&
                        (this.renderer.text(c[d], b.left, b.bottom),
                        this.renderTextDecoration(
                          a.parent,
                          b,
                          this.fontMetrics.getMetrics(f, e)
                        ));
                    },
                    this);
                  },
        ...
        function (a, b, c) {
          ...
          (d.prototype.renderImage = function (a, b, c, d) {
            ...
            (d.prototype.renderBackground = function (a, b, c) {
              b.height > 0 &&
                b.width > 0 &&
                (this.renderBackgroundColor(a, b),
        ...
        function (a, b, c) {
          ...
          (d.prototype = Object.create(f.prototype)),
            (d.prototype.setFillStyle = function (a) {
              return (
                (this.ctx.fillStyle =
                  "object" == typeof a && a.isColor ? a.toString() : a),
                this.ctx
              );
            }),
              ...
              return (
                ...
                a.forEach(function (a, b) {
                  "rect" === a[0]
                    ...
                    : this.ctx[0 === b ? "moveTo" : a[0] + "To"].apply(
                        this.ctx,
                        a.slice(1)
                      );
                }, this),
            ...
            (d.prototype.backgroundRepeatShape = function (
              a,
              b,
              c,
              d,
            ...
            (d.prototype.renderBackgroundRepeat = function (a, b, c, d, e, f) {
              ...
              this.setFillStyle(
                this.ctx.createPattern(this.resizeImage(a, c), "repeat")
              ),
        ...
        function (a, b, c) {
          function d(a, b, c, d) {
            e.call(this, c, d),
              ...
              (this.children = []),
              (this.opacity =
                (this.parent ? this.parent.stack.opacity : 1) * b);
          }
          var e = a("./nodecontainer");
          (d.prototype = Object.create(e.prototype)),
        ...
        function (a, b, c) {
          function d(a) {
            ...
            this.promise = this.hasFabric()
              .then(function () {
                return b.isInline(a)
                  ? Promise.resolve(b.inlineFormatting(a))
                  : e(a);
              })
              .then(function (a) {
              ...
              return function (c, d) {
                ...
                (b.image = e.lowerCanvasEl),
                  e
                    ...
                    .setHeight(d.height)
                    .add(
                      window.html2canvas.svg.fabric.util.groupSVGElements(c, d)
                    )
                    .renderAll(),
                  a(e.lowerCanvasEl);
              };
        ...
        function (a, b, c) {
          function d(a) {
            e.apply(this, arguments),
              (this.type =
                "linear" === a.args[0] ? e.TYPES.LINEAR : e.TYPES.RADIAL);
          }
          var e = a("./gradientcontainer");
          (d.prototype = Object.create(e.prototype)), (b.exports = d);
        },
